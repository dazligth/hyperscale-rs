...
pub use beacon::{
    ...
    EquivocationEvidence, MAX_BEACON_WITNESS_EVENTS_PER_TX, MAX_EXCLUDED_VALIDATORS,
    ...
    PcVoteEquivocation, PcVoteRound, PcXpProof, ReadySignal, RecoveryCertificate,
    RecoveryEquivocation, RecoveryRequest, SHARD_WITNESS_LEAF_DOMAIN_TAG, ShardWitness,
