...
///
/// The block is self-authenticating via the committee aggregate
/// signature in [`BeaconBlock::aggregate_sig`] — verifiers check it
/// under the union of [`BeaconBlock::signers`]' pubkeys at the slot's
/// committee enumeration. No outer sender signature is needed; multiple
...
mod tests {
    ...
    use super::*;
    use crate::BeaconStateRoot;

    #[test]
    fn sbor_round_trip() {
        let block = BeaconBlock::genesis(BeaconStateRoot::ZERO);
